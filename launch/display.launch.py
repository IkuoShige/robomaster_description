...
def urdf(name: str = '', model: str = 's1',
...
def robot_state_publisher(context: LaunchContext,
    ...
    kwargs = {k: perform_substitutions(context, [v]) for k, v in substitutions.items() if k != 'use_rviz'}
...
def generate_launch_description() -> None:
    ...
    kwargs['use_rviz'] = LaunchConfiguration('use_rviz')
